...
open class UltronRecyclerView(
    ...
    override fun describeTo(description: Description?) {
        description?.appendText("Custom description of what a matching object should be like")

    }

    override fun matches(actual: Any?): Boolean {
        return actual is Any
    }

    override fun describeMismatch(actual: Any?, mismatchDescription: Description?) {
        mismatchDescription?.appendText("Custom description of the mismatch")
    }
